                ...
                <ul class="nav-links">
                    ...
                    <li>
                       <div class="icon-link">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item" title="staff">
                                <router-link to="/request" class="nav-link"><i class="bi bi-record"></i> <span class="nav-name">Create Staff  </span>  </router-link>
                            </li>
                            <li class="nav-item" title="staff">
                                <router-link to="/staff-list" class="nav-link"><i class="bi bi-record"></i> <span class="nav-name">Staff List</span>  </router-link>
                            </li>
                        ...
                        <li>
                         ...
                         <li>
                               <div class="icon-link">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item" title="staff">
                                        <router-link to="/my-raw-material-request" class="nav-link"><i class="bi bi-record"></i> <span class="nav-name">My Request</span>  </router-link>
                                    </li>
                                    <li class="nav-item" title="staff">
                         ...
                         <li>
                               <div class="icon-link">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item" title="raw materials">
                                        <router-link to="/inventory-item-request" class="nav-link"><i class="bi bi-record"></i> <span class="nav-name">New Request</span>  </router-link>
                                    </li>
                                    <li class="nav-item" title="staff">
