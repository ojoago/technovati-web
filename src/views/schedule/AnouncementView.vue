<template>
    <div>
        <div class="container mt-2">
                    <div class="card">
                        <div class="card-header">Announcements  <button class="btn btn-sm btn-primary" @click="anounceModal">Add New</button> </div>
                        <div class="card-body">
                                ...
                                <table class="table-hover table-stripped table-bordered table" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width = "20%" style="width: 10% !important;" class="text-ellipsis text-truncate">Body</th>
                                    ...
                                    <tbody>
                                        <tr v-for="(data, loop) in announcements.data" :key="loop">
                                            <td>{{ loop + 1 }}</td>
                                            <td class="text-ellipsis">{{ data.title }}</td>
                                            <td class="text-ellipsis text-truncate" style="width: 10% !important;">{{ data.body }}</td>
                                            ...
                                            <td>
                                                <div class="dropdown" v-if="data.status == 0">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item pointer bg-success" @click="publishAnnouncement(data.pid)">Publish</a> </li>
                                                        <li><a class="dropdown-item pointer bg-warning" @click="editAnnounce(data)">Edit</a> </li>
                                                        <li><a class="dropdown-item pointer bg-danger" @click="deleteAnnounce(data.pid)">Delete</a> </li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
        ...
        <o-modal :isOpen="toggleModal" modal-class="modal-md" title="Make Announcement" @submit="makeAnnouncement" @modal-close="closeModal" >
                        <template #content>
                              <form id="anForm">
                                        <div class="row">
                                            <div class="col-md-12">
