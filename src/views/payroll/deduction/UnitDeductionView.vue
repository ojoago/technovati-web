            ...
            <div class="card">
                <div class="card-body">
                    <fieldset class="border rounded-3 p-2 m-1">
                        <legend class="float-none w-auto px-2">deduction Allowance</legend>
                        <form id="deductionForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <p class="text-danger " v-if="errors?.grade.grade_pid">{{
                                                    errors?.grade.grade_pid[0] }} </p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <p class="text-danger " v-if="errors?.grade.step">{{ errors?.grade.step[0]
                                                }} </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <p class="text-danger " v-if="errors?.period.from">{{ errors?.period.from[0]
                                                }} </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <button type="button" class="btn btn-success btn-sm mt-2"
                                @click="createUnitDeduction">Submit</button>
                        </form>
                    </fieldset>
                    <div class="col-md-12">
                        <div class="card">
